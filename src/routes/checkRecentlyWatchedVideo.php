...
$app->post('/api/Dailymotion/checkRecentlyWatchedVideo', function ($request, $response) {
    ...
    $optionalParams = ['userId'=>'userId','fields'=>'fields'];
    $bodyParams = [
       'query' => ['fields']
    ];
    ...
    $query_str = "https://api.dailymotion.com/user/{$data['userId']}/history/{$data['videoId']}";
